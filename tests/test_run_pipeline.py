...
class TestRunPipeline:
    @patch("run_pipeline.psql_loader.main")
    @patch("run_pipeline.staging.main")
    @patch("run_pipeline.validate.main")
    @patch("run_pipeline.ingest_api.main")
    def test_runs_all_steps_in_order(
        ...
        mock_validate.assert_called_once_with("2022-01-01", "2022-01-02")
    ...
    def test_skip_ingest_reuses_existing_raw_files(
        ...
        mock_validate.assert_called_once_with("2022-01-01", "2022-01-01")
